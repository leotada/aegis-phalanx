...
```
telegram_listener.py   # Composition root: wires services and exposes the bot entrypoint
orchestrator/          # Object services (pipeline, review, git, process, parsing, bot)
agents/
