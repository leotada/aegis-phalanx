...
PR_REVIEW_CONFIG = [
    {
        ...
        "prompt": (
            ...
            "Report ONLY problems that require action. Do NOT describe what is correct, "
            "well done, or acceptable. Do NOT summarize the PR, praise the author, restate "
            "the diff, or offer general observations. No positive feedback, no reassurance, "
            "no filler. If a category has no actionable findings, omit it entirely. If the "
            "entire PR has no actionable findings, reply with the single line: "
